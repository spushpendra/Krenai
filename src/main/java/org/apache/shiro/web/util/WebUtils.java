...
public class WebUtils {
    ...
    public static SavedRequest getAndClearSavedRequest(ServletRequest request) {
        ...
        SavedRequest savedRequest2 = null;
        SavedRequest savedRequest3 = null;
        if (savedRequest != null) {
            Subject subject = SecurityUtils.getSubject();
            Session session = subject.getSession();
            savedRequest2 = (SavedRequest) session.getAttribute(SAVED_REQUEST_KEY);
    ...
    public static void redirectToSavedRequest(ServletRequest request, ServletResponse response, String fallbackUrl)
        ...
        //comments to redirect to successurl after login
        
        //if (savedRequest != null && savedRequest.getMethod().equalsIgnoreCase(AccessControlFilter.GET_METHOD)) {
         //   successUrl = savedRequest.getRequestUrl();
        //    contextRelative = false;
        //    System.out.println("*************webutills inside redired to saved if...."+successUrl);
       // }
