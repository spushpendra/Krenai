...
public abstract class AuthenticatingRealm extends CachingRealm implements LogoutAware {
    ...
    private CredentialsMatcher credentialsMatcher = new HashedCredentialsMatcher();
    /**
    ...
    public final AuthenticationInfo getAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        System.out.println("**************AuthenticationInfo.getcredentials *******************"+info.getCredentials().toString());
        if (info == null) {
        ...
        System.out.println("******************credential matcher*******************"+cm.doCredentialsMatch(token, info));
        if (cm != null) {
        	System.out.println("******************CredentialsMatcher *******************cm is not null");
